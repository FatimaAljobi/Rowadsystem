        ...
        <div class="row align-items-md-stretch mb-3">
          <div class="col-md-5">
            <div class="h-100 p-5 bg-light border rounded-3">
              <h2>قائمةالمشتركين</h2>
              <p> لحذف احد المشتركين او تعديل بياناته</p>
              <a class="nav-link" href="Edit&Delete.php"><button class="btn btn-outline-secondary" type="button">أضغط هنا</button></a>
            </div>
          </div>
          <div class="col-md-5">
            <div class="h-100 p-5 text-white bg-dark rounded-3">
              <h2>إضافة</h2>
              <p> لأضافة المشتركين</p>
              <a class="nav-link" href="Add1.php"><button class="btn btn-outline-light" type="button">أضغط هنا</button></a>   
            </div>
          </div>
      </div>

      <div class="btn-group btn-center" role="group" aria-label="back"  >
