...
<form method='POST'> 
    ...
    <div class="container py-4" dir="ltr">
      ...
      <div class="col-md-12">
        ...
        <h2> تأكيد الحجز</h2>
        <p>تأكيد وحجز مقاعد المشتركين الذين دفعوا رسوم الفعالية</p>
        </div>
      </div>
        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th  type="checkbox" scope= "col" >التأكيد</th>
          ...
          $temp = 0;
                    ...
                    echo '<td> 
                                ...
                                <input type="checkbox" onChange="this.form.submit()" name="confirmation" value="Yes" />
                                </form></td>  ';
                        echo "</tr>";
                      }
                      $i=1;
