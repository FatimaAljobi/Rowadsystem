...
<?php
        session_start();
            ...
            $result=mysqli_query($conn,"select * from waitinglist");
            ...
            if (isset($_POST['submit'])) {
              ...
              if ($connect->connect_error) {
                  ...
                  $result=mysqli_query($connect,"SELECT * FROM  waitinglist WHERE activity='$activity'OR pname='$pname'");         
              }  
           }
        ...
        <div class="container py-4" dir="ltr">
          <div class="col-md-12">
            ...
            <div  dir="rtl" style=" float: right;"> 
              ...
              <p> (only 5) المشاركين الذي أنضموا الى قائمة الأنتظار</p>
            </div>
          </div>
